...
public enum FightProperty : uint
{
    FIGHT_PROP_NONE = 0,
    ...
    FIGHT_PROP_STAMINA_COST_REDUCTION_BASE = 9900,
    FIGHT_PROP_STAMINA_COST_REDUCTION_PERCENT = 9901,
    FIGHT_PROP_STAMINA_REGEN_ADD_BASE = 9902,
    FIGHT_PROP_STAMINA_REGEN_ADD_PERCENT = 9903
}

public static class FightPropertyExtensions
{
    public static bool TryParse(string? name, out FightProperty property)
    {
        if (!string.IsNullOrEmpty(name) && Enum.TryParse(name, ignoreCase: false, out property))
            return true;
    ...
    public static float GetValue(this IReadOnlyDictionary<FightProperty, float> values, FightProperty property) =>
